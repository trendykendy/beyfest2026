...
#   start.sh, pi-kiosk.sh, beyfest-wifi.sh, pb/pocketbase, pb/pb_migrations, web/build, web/node_modules,
#   VERSION
# ─────────────────────────────────────────────────────────────────────
set -euo pipefail
...
chmod +x "$stage/pb/pocketbase" "$stage/start.sh" "$stage/pi-kiosk.sh" "$stage/beyfest-wifi.sh"
